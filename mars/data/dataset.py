r""" Dataloader builder for few-shot semantic segmentation dataset. Adapted from Matcher."""
from torchvision import transforms
from torch.utils.data import DataLoader

from .coco import DatasetCOCO
from .pascal5i import DatasetPASCAL5i
...
class FSSDataset:
    ...
    def build_dataloader(cls, benchmark, bsz, nworker, fold, split, shot=1):
        ...
        dataloader = DataLoader(dataset, batch_size=bsz,
                                shuffle=shuffle, num_workers=nworker)
