...
do
  python main_MARS.py  \
    ...
    --annotations_datapath /home/pertino/exp/private_datasets/COCO2014/annotations \
    --nltk_path /home/pertino/exp/NLTK_data \
    --mask_proposals_path /home/pertino/exp/MARS-Multimodal-Alignment-and-Ranking-System-for-Few-Shot-Segmentation/vis/coco_test/5shot/coco_test_pred_masks_unmerged_unfiltered/ \
    --benchmark coco \
    --nworker 0 \
    --nshot 5 \
    --fold ${fold} \
    ...
    --alpha_coverage 0.85 \
    --log_root_path /home/pertino/exp/MARS-Multimodal-Alignment-and-Ranking-System-for-Few-Shot-Segmentation/output/mars/coco/fold${fold} \
    --exp_name 5shot
done
wait
