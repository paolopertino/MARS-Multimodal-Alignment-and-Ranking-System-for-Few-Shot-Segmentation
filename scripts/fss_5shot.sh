...
do
  python main_MARS.py  \
    ...
    --mask_proposals_path /home/pertino/exp/MARS-Multimodal-Alignment-and-Ranking-System-for-Few-Shot-Segmentation/vis/fss_test/5shot/fss_test_pred_masks_unmerged_unfiltered/ \
    --benchmark fss \
    --nworker 0 \
    --nshot 5 \
    --fold ${fold} \
    ...
    --alpha_coverage 0.85 \
    --log_root_path /home/pertino/exp/MARS-Multimodal-Alignment-and-Ranking-System-for-Few-Shot-Segmentation/output/mars/fss/fold${fold} \
    --exp_name 5shot
done
wait
