...
do
  python main_MARS.py  \
    ...
    --mask_proposals_path /home/pertino/exp/MARS-Multimodal-Alignment-and-Ranking-System-for-Few-Shot-Segmentation/vis/coco_test/coco_test_pred_masks_unmerged_unfiltered/ \
    --benchmark coco \
    --nworker 0 \
    --nshot 1 \
    --fold ${fold} \
